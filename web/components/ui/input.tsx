...
/*
 * A field is white on a page that is not.
 *
 * `bg-transparent` was right when the page was pure white and the border
 * did all the work. On a ground a shade below white it made every input
 * read as a line drawn around nothing -- and a form of them read as a
 * table. Filling it is what says "type here".
 */
